...
class ZoviraxTreatmentActivity: AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_zoviraxtreatmentactivity)
...
// Add TextChangedListeners to EditTexts if needed to handle text input
    ...
    private fun showThankYouAlert() {
        ...
        intent.putExtra("medication", "Zovirax") // Replace "Finpecia" with the actual medication type
